...
#************** How to run it *******************
# source ./delete_all_subchanges_with_inner_joins_v3.sql	- make sure to specify the correct path
...
SET @v_command = CONCAT('CREATE TABLE ', @new_tablename, '  ENGINE = InnoDB, DEFAULT CHARACTER SET = utf8 AS SELECT * FROM tcck_ann2;');
PREPARE stmt3 FROM @v_command;
EXECUTE stmt3;
DEALLOCATE PREPARE stmt3;
