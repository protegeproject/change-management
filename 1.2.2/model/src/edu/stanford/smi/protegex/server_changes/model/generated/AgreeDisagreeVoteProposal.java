...
/** 
 */
public class AgreeDisagreeVoteProposal extends VotingProposal {

	public AgreeDisagreeVoteProposal() {
	}


	public AgreeDisagreeVoteProposal(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}
