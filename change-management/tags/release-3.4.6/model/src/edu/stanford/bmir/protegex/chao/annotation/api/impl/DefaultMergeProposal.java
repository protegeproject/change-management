...
import edu.stanford.bmir.protegex.chao.annotation.api.MergeProposal;
...
public class DefaultMergeProposal extends DefaultProposal
    ...
    public Ontology_Component getEntity1() {
        Object object = getWrappedProtegeInstance().getOwnSlotValue(getEntity1Slot());
    ...
    public boolean hasEntity1() {
        return hasSlotValues(getEntity1Slot());
    }


    public void setEntity1(Ontology_Component newEntity1) {
        setSlotValue(getEntity1Slot(), newEntity1);
    }

    // Slot entity2

    public Ontology_Component getEntity2() {
        Object object = getWrappedProtegeInstance().getOwnSlotValue(getEntity2Slot());
        Cls cls = getKnowledgeBase().getCls("Ontology_Component");
        if (object instanceof Instance && ((Instance)object).hasType(cls)) {
            return new DefaultOntology_Component((Instance)object);
        }
    ...
    public boolean hasEntity2() {
        return hasSlotValues(getEntity2Slot());
    }


    public void setEntity2(Ontology_Component newEntity2) {
        setSlotValue(getEntity2Slot(), newEntity2);
    }
    ...
    public Status getHasStatus() {
        ...
        Cls cls = getKnowledgeBase().getCls("AnnotationStatus");
        if (object instanceof Instance && ((Instance)object).hasType(cls)) {
