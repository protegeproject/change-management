...
import edu.stanford.bmir.protegex.chao.annotation.api.FiveStarsVote;
 ...
 */
public class DefaultFiveStarsVote extends DefaultVote
         implements FiveStarsVote {

    private static final long serialVersionUID = -4786399421898390116L;


    public DefaultFiveStarsVote(Instance instance) {
        super(instance);
    }


    public DefaultFiveStarsVote() {
    }
	...
	public String getVoteValue() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getVoteValueSlot());
    }
	...
	public boolean hasVoteValue() {
        return hasSlotValues(getVoteValueSlot());
    }


    @Override
	public void setVoteValue(String newVoteValue) {
        setSlotValue(getVoteValueSlot(), newVoteValue);
    }
}
