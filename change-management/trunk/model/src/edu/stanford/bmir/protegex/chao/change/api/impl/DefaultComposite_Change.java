...
public class DefaultComposite_Change extends DefaultChange
    ...
    public DefaultComposite_Change() {
    }
    ...
    public Collection<Change> getSubChanges() {
        Collection protegeValues = getWrappedProtegeInstance().getOwnSlotValues(getSubChangesSlot());
    ...
    public boolean hasSubChanges() {
        return hasSlotValues(getSubChangesSlot());
    }


    public void addSubChanges(Change newSubChanges) {
        addSlotValue(getSubChangesSlot(), newSubChanges);
    }


    public void removeSubChanges(Change oldSubChanges) {
        removeSlotValue(getSubChangesSlot(), oldSubChanges);
    }


    public void setSubChanges(Collection<? extends Change> newSubChanges) {
        setSlotValues(getSubChangesSlot(), newSubChanges);
    }
