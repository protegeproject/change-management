...
import edu.stanford.bmir.protegex.chao.annotation.api.ReviewRequest;
...
public class DefaultReviewRequest extends DefaultAnnotation
    ...
    public boolean getCompleted() {
        java.lang.Boolean value = (java.lang.Boolean) getWrappedProtegeInstance().getOwnSlotValue(getCompletedSlot());
    ...
    public boolean hasCompleted() {
        return hasSlotValues(getCompletedSlot());
    }


    public void setCompleted(boolean newCompleted) {
        setSlotValue(getCompletedSlot(), new java.lang.Boolean(newCompleted));
    }
    ...
    public String getDeadline() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getDeadlineSlot());
    }
    ...
    public boolean hasDeadline() {
        return hasSlotValues(getDeadlineSlot());
    }


    public void setDeadline(String newDeadline) {
        setSlotValue(getDeadlineSlot(), newDeadline);
    }
    ...
    public Reviewer getReviewer() {
        Object object = getWrappedProtegeInstance().getOwnSlotValue(getReviewerSlot());
        Cls cls = getKnowledgeBase().getCls("Reviewer");
        if (object instanceof Instance && ((Instance)object).hasType(cls)) {
            return new DefaultReviewer((Instance)object);
        }
        return null;
    }
    ...
    public boolean hasReviewer() {
        return hasSlotValues(getReviewerSlot());
    }


    public void setReviewer(Reviewer newReviewer) {
        setSlotValue(getReviewerSlot(), newReviewer);
    }
