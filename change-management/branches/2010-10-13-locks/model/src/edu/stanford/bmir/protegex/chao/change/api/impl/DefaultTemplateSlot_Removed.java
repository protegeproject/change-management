...
import edu.stanford.bmir.protegex.chao.change.api.TemplateSlot_Removed;
...
public class DefaultTemplateSlot_Removed extends DefaultClass_Change
    ...
    public DefaultTemplateSlot_Removed() {
    }
    ...
    public String getChanges_Slot_1() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getChanges_Slot_1Slot());
    }
    ...
    public boolean hasChanges_Slot_1() {
        return hasSlotValues(getChanges_Slot_1Slot());
    }


    public void setChanges_Slot_1(String newChanges_Slot_1) {
        setSlotValue(getChanges_Slot_1Slot(), newChanges_Slot_1);
    }
