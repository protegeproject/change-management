 ...
 */
public interface Composite_Change extends Change {
    ...
    Collection<Change> getSubChanges();

    boolean hasSubChanges();

    void addSubChanges(Change newSubChanges);

    void removeSubChanges(Change oldSubChanges);

    void setSubChanges(Collection<? extends Change> newSubChanges);
