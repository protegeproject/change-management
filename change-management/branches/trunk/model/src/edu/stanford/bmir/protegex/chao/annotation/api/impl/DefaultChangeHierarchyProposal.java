...
import edu.stanford.bmir.protegex.chao.annotation.api.ChangeHierarchyProposal;
...
public class DefaultChangeHierarchyProposal extends DefaultProposal
    ...
    public DefaultChangeHierarchyProposal() {
    }
    ...
    public Collection<Ontology_Component> getNewParents() {
        Collection protegeValues = getWrappedProtegeInstance().getOwnSlotValues(getNewParentsSlot());
    ...
    public boolean hasNewParents() {
        return hasSlotValues(getNewParentsSlot());
    }


    public void addNewParents(Ontology_Component newNewParents) {
        addSlotValue(getNewParentsSlot(), newNewParents);
    }


    public void removeNewParents(Ontology_Component oldNewParents) {
        removeSlotValue(getNewParentsSlot(), oldNewParents);
    }


    public void setNewParents(Collection<? extends Ontology_Component> newNewParents) {
        setSlotValues(getNewParentsSlot(), newNewParents);
    }

    // Slot oldParents

    public Collection<Ontology_Component> getOldParents() {
        Collection protegeValues = getWrappedProtegeInstance().getOwnSlotValues(getOldParentsSlot());
        Collection<Ontology_Component> values = new ArrayList<Ontology_Component>();
        Cls cls = getKnowledgeBase().getCls("Ontology_Component");
        for (Object object : protegeValues) {
            if (object instanceof Instance && ((Instance)object).hasType(cls)) {
    ...
    public boolean hasOldParents() {
        return hasSlotValues(getOldParentsSlot());
    }


    public void addOldParents(Ontology_Component newOldParents) {
        addSlotValue(getOldParentsSlot(), newOldParents);
    }


    public void removeOldParents(Ontology_Component oldOldParents) {
        removeSlotValue(getOldParentsSlot(), oldOldParents);
    }


    public void setOldParents(Collection<? extends Ontology_Component> newOldParents) {
        setSlotValues(getOldParentsSlot(), newOldParents);
    }
    ...
    public String getRelationType() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getRelationTypeSlot());
    }
    ...
    public boolean hasRelationType() {
        return hasSlotValues(getRelationTypeSlot());
    }


    public void setRelationType(String newRelationType) {
        setSlotValue(getRelationTypeSlot(), newRelationType);
    }
