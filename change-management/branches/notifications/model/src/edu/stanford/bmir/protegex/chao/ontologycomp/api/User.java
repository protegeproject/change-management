...
public interface User {
    ...
    Collection<Ontology_Component> getWatchedBranch();

    boolean hasWatchedBranch();

    void addWatchedBranch(Ontology_Component newWatchedBranch);

    void removeWatchedBranch(Ontology_Component oldWatchedBranch);

    void setWatchedBranch(Collection<? extends Ontology_Component> newWatchedBranch);
