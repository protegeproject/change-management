...
public class DefaultName_Changed extends DefaultChange
    ...
    public String getNewName() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getNewNameSlot());
    }
    ...
    public boolean hasNewName() {
        return hasSlotValues(getNewNameSlot());
    }


    public void setNewName(String newNewName) {
        setSlotValue(getNewNameSlot(), newNewName);
    }

    // Slot oldName

    public String getOldName() {
        return (String) getWrappedProtegeInstance().getOwnSlotValue(getOldNameSlot());
    }
    ...
    public boolean hasOldName() {
        return hasSlotValues(getOldNameSlot());
    }


    public void setOldName(String newOldName) {
        setSlotValue(getOldNameSlot(), newOldName);
    }
